	...
	public String parseJson(String response) {
		try {
			...
			if (message.equalsIgnoreCase(Constants.SUCCESS)) {
				...
				AppController.setRiderId(jsonObject.getString("riderId"));
				...
				if (jsonObject.getString("homeAddress")
						.equalsIgnoreCase("null")) {
					Rider.setHome_detail("null");
				} else {
					Rider.setHome_detail(jsonObject.getString("homeAddress"));
					Rider.setHome_lat(Double.parseDouble(jsonObject
							.getString("homeAddressLat")));
					Rider.setHome_lng(Double.parseDouble(jsonObject
							.getString("homeAddressLng")));
				}

				if (jsonObject.getString("officeAddress").equalsIgnoreCase(
						"null")) {
					Rider.setWork_detail("null");
				} else {
					Rider.setWork_detail(jsonObject.getString("officeAddress"));
					Rider.setWork_lat(Double.parseDouble(jsonObject
							.getString("officeAddressLat")));
					Rider.setWork_lng(Double.parseDouble(jsonObject
							.getString("officeAddressLng")));
				}
				try {
