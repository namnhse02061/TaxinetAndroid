...
public class CustomDateTimePicker implements OnClickListener {
	...
	public View getDateTimePickerLayout() {
		...
		btn_setDate.setText(activity.getString(R.string.set_date));
		btn_setDate.setId(SET_DATE);
		btn_setDate.setOnClickListener(this);

		btn_setTime = new Button(activity);
		btn_setTime.setLayoutParams(button_params);
		btn_setTime.setText(activity.getString(R.string.set_time));
		...
		btn_set.setText(activity.getString(R.string.set));
		btn_set.setId(SET);
		btn_set.setOnClickListener(this);

		btn_cancel = new Button(activity);
		btn_cancel.setLayoutParams(button_params);
		btn_cancel.setText(activity.getString(R.string.cancel));
	...
	private String getAMPM(Calendar calendar) {
		String ampm = (calendar.get(Calendar.AM_PM) == (Calendar.AM)) ? activity
				.getString(R.string.am) : activity.getString(R.string.pm);
		return ampm;
	}
