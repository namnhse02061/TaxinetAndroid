...
public class PlaceProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "vn.co.taxinet.mobile.googleapi.PlaceProvider";
	...
	String mKey = "key=AIzaSyD_Mt5zaPIi6z-TllhNHR9NyRIeq6PdMGk";
		...
		case DETAILS:
			...
			for (int j = 0; j < detailsList.size(); j++) {
				...
				mCursor.addRow(new String[] {
						...
						hMapDetails.get("lat"), hMapDetails.get("lng"),
						hMapDetails.get("country"), hMapDetails.get("city"),
						hMapDetails.get("address") });
			}
			c = mCursor;
			break;
